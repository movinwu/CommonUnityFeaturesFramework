...
namespace HotfixScripts
{
    ...
    /// 数据表基类
    /// </summary>
    public class DT_Example2 : IDataTable
    {
        /// <summary>
        /// 所有数据
        /// </summary>
        private Dictionary<int, DR_Example2> m_AllDataDic;

        /// <summary>
        /// 所有数据
        /// </summary>
        private DR_Example2[] m_AllDataArray;

        public void FromBinary(BinaryReader reader)
        {
            m_AllDataDic = new Dictionary<int, DR_Example2>();
            int count = reader.ReadInt32();
            m_AllDataArray = new DR_Example2[count];
            for (int i = 0; i < count; i++)
            {
                var dataRow = new DR_Example2();
        ...
        {
            m_AllDataArray = JsonMapper.ToObject<DR_Example2[]>(json);
            m_AllDataDic = new Dictionary<int, DR_Example2>();
