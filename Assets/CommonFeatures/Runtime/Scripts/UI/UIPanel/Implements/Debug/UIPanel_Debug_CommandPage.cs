...
{
    public class UIPanel_Debug_CommandPage : PageEx
    {
        ...
        internal void RegistCommand(string command, Func<string[], bool> excuteFunc, string notice)
        {
            if (m_AllCommand.ContainsKey(command))
            {
