        ...
        public static void CopyToStreamingAssets()
        {
            ...
            foreach (AssetsSetting assetsSetting in assetLoadTable.AssetsSettings)
            {
                ...
                foreach (FileInfo fileInfo in fileInfos)
                {
                    ...
                    {
                        CommonFeatures.Log.CommonLog.ResourceError("找不到文件的路径: " + fileInfo.Name);
                        continue;
                    }
            ...
            CommonFeatures.Log.CommonLog.Resource("已将资源复制到StreamingAssets");
        }
        
        [MenuItem("Tools/BuildAsset/实用工具/清空热更目录下的文件")]
        public static void ClearHotfixPathPath()
        {
            BuildAssetsTools.DeleteDir("");
            AssetDatabase.Refresh();
        }
